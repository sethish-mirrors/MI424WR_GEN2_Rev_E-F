...
{
    /* XXX The following comment is not true any more (incorrect (e.g. 64)
       cache line size generates a lot of PCI errors under heavy traffic):
    ...
    pci_write_config_byte(dev, PCI_CACHE_LINE_SIZE, 128/4);
