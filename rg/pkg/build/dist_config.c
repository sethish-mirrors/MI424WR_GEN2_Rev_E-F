...
{
    token_set("CONFIG_RG_HOST_NAME", "homerouter"); 
...
//	enable_module("MODULE_RG_JVM");
	...
	*/
    ...
    else if (IS_DIST("MC524WR") || IS_DIST("CN3XXX_AEI"))
    {
    	char *lan;

	if (!token_get("CONFIG_MC524WR_REV"))
	    token_set("CONFIG_MC524WR_REV", "0x2A");

    	if (IS_DIST("CN3XXX_AEI"))
	{
	    lan = "eth1";
	    hw = "CN3XXX";
	}
...
/*	enable_module("MODULE_RG_ROUTE_MULTIWAN"); */
	...
	dev_add_bridge("br0", DEV_IF_NET_INT, lan, NULL);
	dev_add_to_bridge_if_opt("br0", "ath0", "CONFIG_RG_ATHEROS_HW_AR5212");
	dev_add_to_bridge_if_opt("br0", "ath0", "CONFIG_RG_ATHEROS_HW_AR5416");
	dev_add_to_bridge_if_opt("br0", "clink0", "CONFIG_HW_MOCA");
	...
	dev_add_bridge("br0", DEV_IF_NET_INT, "ixp1", NULL);
	dev_add_to_bridge_if_opt("br0", "clink1",
	    "CONFIG_HW_MOCA");
	dev_add_to_bridge_if_opt("br0", "ra0",
	    "CONFIG_HW_80211G_RALINK_RT2561");
	dev_add_to_bridge_if_opt("br0", "ra0",
	...
	dev_add_to_bridge_if_opt("br0", "ath0",
	    "CONFIG_RG_ATHEROS_HW_AR5212");
	dev_add_to_bridge_if_opt("br0", "ath0",
	    "CONFIG_RG_ATHEROS_HW_AR5416");
