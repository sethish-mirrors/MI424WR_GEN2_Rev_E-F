 ...
 *
 *  $Id: sa1100.c,v 1.3 2006/06/15 21:34:22 itay Exp $
 *
 */
...
static int __init sa1100_serial_init(void)
{
	...
	printk(KERN_INFO "Serial: SA11x0 driver $Revision: 1.3 $\n");
...
MODULE_DESCRIPTION("SA1100 generic serial port driver $Revision: 1.3 $");
MODULE_LICENSE("GPL");
