 ...
 *
 *  $Id: 21285.c,v 1.3 2006/06/15 21:34:20 itay Exp $
 */
...
static int __init serial21285_init(void)
{
	...
	printk(KERN_INFO "Serial: 21285 driver $Revision: 1.3 $\n");
...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("Intel Footbridge (21285) serial driver $Revision: 1.3 $");
