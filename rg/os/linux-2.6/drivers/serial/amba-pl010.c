 ...
 *
 *  $Id: amba-pl010.c,v 1.3 2006/06/15 21:34:21 itay Exp $
 *
...
static int __init pl010_init(void)
{
	...
	printk(KERN_INFO "Serial: AMBA driver $Revision: 1.3 $\n");
...
MODULE_DESCRIPTION("ARM AMBA serial port driver $Revision: 1.3 $");
MODULE_LICENSE("GPL");
