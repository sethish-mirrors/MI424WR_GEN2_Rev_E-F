 ...
 *
 *  $Id: 8250.c,v 1.5.12.1 2007/08/16 02:56:03 alex Exp $
 *
...
static int __init serial8250_init(void)
{
	...
	printk(KERN_INFO "Serial: 8250/16550 driver $Revision: 1.5.12.1 $ "
...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("Generic 8250/16x50 serial driver $Revision: 1.5.12.1 $");
