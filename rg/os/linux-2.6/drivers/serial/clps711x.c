 ...
 *
 *  $Id: clps711x.c,v 1.3 2006/06/15 21:34:21 itay Exp $
 *
 */
...
static int __init clps711xuart_init(void)
{
	...
	printk(KERN_INFO "Serial: CLPS711x driver $Revision: 1.3 $\n");
...
MODULE_DESCRIPTION("CLPS-711x generic serial driver $Revision: 1.3 $");
MODULE_LICENSE("GPL");
