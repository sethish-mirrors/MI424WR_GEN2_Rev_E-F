 ...
 *   
 *  $Log: pc300_tty.c,v $
 *  Revision 1.3  2006/06/15 21:30:35  itay
 *  B33147 Upgrade kernel to linux-2.6.16.14
 *  OPTIONS: novalidate
 *
 *  Revision 1.2.34.1  2006/06/14 11:10:21  itay
 *  B33147 Upgrade kernel to linux-2.6.16.14 and add support for broadcom 6358 (merge from branch-4_2_3_2)
 *  OPTIONS: novalidate
 *
 *  Revision 1.2.28.1  2006/05/17 15:27:49  itay
 *  B33147 merge changes between linux-2_6_12 and linux-2_6_16_14
 *  NOTIFY: cancel
 *  OPTIONS: novalidate
 *
 *  Revision 1.2  2005/08/08 06:50:49  noams
 *  B24862 Initial import of linux-2.6.12
 *
 *  Revision 1.1.2.1  2005/08/07 13:18:44  noams
 *  B24862 Initial import of linux-2.6.12
 *  Revision 1.1.2.3  2006/05/08 14:53:20  itay
 *  B33147 import linux-2.6.16.14 to branch-vendor (2nd try, the previous
 *  commit for this bug should be ignored)
 *  OPTIONS: novalidate
 *
