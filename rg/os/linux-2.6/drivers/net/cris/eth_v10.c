/* $Id: eth_v10.c,v 1.3 2006/06/15 21:29:47 itay Exp $
 *
			     ...
			     struct ethtool_drvinfo *info)
{
	...
	strncpy(info->version, "$Revision: 1.3 $", sizeof(info->version) - 1);
