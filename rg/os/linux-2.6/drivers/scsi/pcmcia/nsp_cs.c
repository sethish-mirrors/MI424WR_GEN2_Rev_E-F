...
/* $Id: nsp_cs.c,v 1.3 2006/06/15 21:33:57 itay Exp $ */
...
MODULE_DESCRIPTION("WorkBit NinjaSCSI-3 / NinjaSCSI-32Bi(16bit) PCMCIA SCSI host adapter module $Revision: 1.3 $");
...
static struct Scsi_Host *nsp_detect(struct scsi_host_template *sht)
{
	...
	snprintf(data->nspinfo,
		 sizeof(data->nspinfo),
		 "NinjaSCSI-3/32Bi Driver $Revision: 1.3 $ IO:0x%04lx-0x%04lx MMIO(virt addr):0x%04lx IRQ:%02d",
	...
	int    inout)
{
	...
	SPRINTF("Driver version:        $Revision: 1.3 $\n");
