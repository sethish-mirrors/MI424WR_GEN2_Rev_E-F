...
static int __init init_per_zone_pages_min(void)
{
	...
	/* Empirically, we find that increasing the value of min_free_kbytes
	 * prevents large order page allocation failuers. See B44523. */
	min_free_kbytes = int_sqrt(lowmem_kbytes * 64);
#else
